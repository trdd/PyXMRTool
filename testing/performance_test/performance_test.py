...
simu.ReadData("Exp_Umgeformt",simu.createLinereader(rsigma_angle_column=0,rsigma_column=1,rpi_angle_column=2, rpi_column=3),pointmodifierfunction=pointmodifier , filenamereaderfunction=namereader)
