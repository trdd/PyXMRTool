...
#FF_Ya=SampleRepresentation.FFfromScaledAbsorption('',E1=250,E2=400,E3=500,scaling_factor=pp.newParameter("Ya_scaling"),absorption_filename="C_imag.F",energyshift=pp.newParameter("Ya_eneryshift"),minE=150,maxE=650,tabulated_filename="C_tabul.F",tabulated_linereaderfunction=SampleRepresentation.FFfromScaledAbsorption.createTabulatedLinereader(complex_numbers=False))
FF_Ya=SampleRepresentation.FFfromScaledAbsorption('C',E1=250,E2=400,E3=500,scaling_factor=pp.newParameter("Ya_scaling"),absorption_filename="C_imag.F",energyshift=pp.newParameter("Ya_eneryshift"),minE=150,maxE=650)
#FF_Ya=SampleRepresentation.FFfromScaledAbsorption('C',E1=250,E2=400,E3=500,scaling_factor=pp.newParameter("Ya_scaling"),absorption_filename="C_imag.F",energyshift=pp.newParameter("Ya_eneryshift"),minE=150,maxE=650,autofitfunction=f2,autofitrange=20)
#FF_Ya=SampleRepresentation.FFfromScaledAbsorption('',E1=250,E2=400,E3=500,scaling_factor=pp.newParameter("Ya_scaling"),absorption_filename="C_imag.F",energyshift=pp.newParameter("Ya_eneryshift"),minE=150,maxE=650,autofitfunction=f2, autofitrange=20, tabulated_filename="C_tabul.F",tabulated_linereaderfunction=SampleRepresentation.FFfromScaledAbsorption.createTabulatedLinereader(complex_numbers=False))
print "... MFF_Ya"
