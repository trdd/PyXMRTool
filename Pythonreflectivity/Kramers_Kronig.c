...
#define __PYX_HAVE__Kramers_Kronig
#define __PYX_HAVE_API__Kramers_Kronig
#include "math.h"
#include <string.h>
#include <stdio.h>
...
static double __pyx_f_14Kramers_Kronig_KKT_Onepoint(int, double *, double *, int); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "Kramers_Kronig"
extern int __pyx_module_is_main_Kramers_Kronig;
int __pyx_module_is_main_Kramers_Kronig = 0;

/* Implementation of 'Kramers_Kronig' */
...
static double __pyx_f_14Kramers_Kronig_KKT_Onepoint(int __pyx_v_j, double *__pyx_v_e, double *__pyx_v_im, int __pyx_v_Lred) {
  double __pyx_v_a;
  double __pyx_v_b;
  double __pyx_v_c;
  double __pyx_v_sum1;
  ...
  __Pyx_RefNannySetupContext("KKT_Onepoint", 0);

  /* "Kramers_Kronig.pyx":6
 *     cdef double a,b,c,sum1
 *     cdef double s1, s2, s3, s4, s5
 *     cdef double e0=e[0]             # <<<<<<<<<<<<<<
 *     cdef double ej=e[j]
 *     cdef int iplus
 */
  __pyx_v_e0 = (__pyx_v_e[0]);

  /* "Kramers_Kronig.pyx":7
 *     cdef double s1, s2, s3, s4, s5
 *     cdef double e0=e[0]
 *     cdef double ej=e[j]             # <<<<<<<<<<<<<<
 *     cdef int iplus
 *     sum1=0
 */
  __pyx_v_ej = (__pyx_v_e[__pyx_v_j]);

  /* "Kramers_Kronig.pyx":9
 *     cdef double ej=e[j]
 *     cdef int iplus
 *     sum1=0             # <<<<<<<<<<<<<<
 *     s2=(ej+e0)
 ...
 *     s5=(ej-e0)
 */
  __pyx_v_s2 = (__pyx_v_ej + __pyx_v_e0);

  /* "Kramers_Kronig.pyx":11
 *     sum1=0
 *     s2=(ej+e0)
 *     s3=e0*im[0]             # <<<<<<<<<<<<<<
 *     s5=(ej-e0)
 *     b=s3/s2
 */
  __pyx_v_s3 = (__pyx_v_e0 * (__pyx_v_im[0]));

  /* "Kramers_Kronig.pyx":12
 *     s2=(ej+e0)
 *     s3=e0*im[0]
 *     s5=(ej-e0)             # <<<<<<<<<<<<<<
 *     b=s3/s2
 *     for i in range(Lred):
 */
  __pyx_v_s5 = (__pyx_v_ej - __pyx_v_e0);

  /* "Kramers_Kronig.pyx":13
 *     s3=e0*im[0]
 *     s5=(ej-e0)
 *     b=s3/s2             # <<<<<<<<<<<<<<
 *     for i in range(Lred):
 ...
 */
  ...
  __pyx_v_b = (__pyx_v_s3 / __pyx_v_s2);

  /* "Kramers_Kronig.pyx":14
 *     s5=(ej-e0)
 *     b=s3/s2
 *     for i in range(Lred):             # <<<<<<<<<<<<<<
 *         iplus=i+1
 *         s1=(e[iplus]-e[i])
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_Lred); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
 ...
 *         c=b
 */
    __pyx_t_1 = __Pyx_PyInt_AddObjC(__pyx_v_i, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = __Pyx_PyInt_As_int(__pyx_t_1); if (unlikely((__pyx_t_5 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_v_iplus = __pyx_t_5;

    /* "Kramers_Kronig.pyx":16
 *     for i in range(Lred):
 *         iplus=i+1
 *         s1=(e[iplus]-e[i])             # <<<<<<<<<<<<<<
 *         c=b
 *         s3=e[iplus]*im[iplus]
 */
    __pyx_t_6 = __Pyx_PyIndex_AsSsize_t(__pyx_v_i); if (unlikely((__pyx_t_6 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L1_error)
    __pyx_v_s1 = ((__pyx_v_e[__pyx_v_iplus]) - (__pyx_v_e[__pyx_t_6]));

    /* "Kramers_Kronig.pyx":17
 *         iplus=i+1
 *         s1=(e[iplus]-e[i])
 *         c=b             # <<<<<<<<<<<<<<
 *         s3=e[iplus]*im[iplus]
 ...
 *         b=s3/s2
 */
    __pyx_v_s3 = ((__pyx_v_e[__pyx_v_iplus]) * (__pyx_v_im[__pyx_v_iplus]));

    /* "Kramers_Kronig.pyx":19
 *         c=b
 *         s3=e[iplus]*im[iplus]
 *         s2=(ej+e[iplus])             # <<<<<<<<<<<<<<
 *         b=s3/s2
 *         a=( b - c)/s1
 */
    __pyx_v_s2 = (__pyx_v_ej + (__pyx_v_e[__pyx_v_iplus]));

    /* "Kramers_Kronig.pyx":20
 *         s3=e[iplus]*im[iplus]
 *         s2=(ej+e[iplus])
 *         b=s3/s2             # <<<<<<<<<<<<<<
 *         a=( b - c)/s1
 ...
 *         s4=s5
 */
    __pyx_t_7 = (__pyx_v_b - __pyx_v_c);
    if (unlikely(__pyx_v_s1 == 0)) {
      PyErr_SetString(PyExc_ZeroDivisionError, "float division");
      __PYX_ERR(0, 21, __pyx_L1_error)
    }
    __pyx_v_a = (__pyx_t_7 / __pyx_v_s1);

    /* "Kramers_Kronig.pyx":22
 *         b=s3/s2
 *         a=( b - c)/s1
 *         sum1=sum1+a*s1             # <<<<<<<<<<<<<<
 *         s4=s5
 *         s5=(ej-e[iplus])
 */
    __pyx_v_sum1 = (__pyx_v_sum1 + (__pyx_v_a * __pyx_v_s1));

    /* "Kramers_Kronig.pyx":23
 *         a=( b - c)/s1
 *         sum1=sum1+a*s1
 *         s4=s5             # <<<<<<<<<<<<<<
 *         s5=(ej-e[iplus])
 *         if(j==iplus ):
 */
    __pyx_v_s4 = __pyx_v_s5;

    /* "Kramers_Kronig.pyx":24
 *         sum1=sum1+a*s1
 *         s4=s5
 *         s5=(ej-e[iplus])             # <<<<<<<<<<<<<<
 *         if(j==iplus ):
 ...
 */
    __pyx_v_s5 = (__pyx_v_ej - (__pyx_v_e[__pyx_v_iplus]));

    /* "Kramers_Kronig.pyx":25
 *         s4=s5
 *         s5=(ej-e[iplus])
 *         if(j==iplus ):             # <<<<<<<<<<<<<<
 *             sum1-=(a*s4+ c )*log( dabsvalue(s4  ))
 *         elif( j==i ):
 */
    __pyx_t_8 = ((__pyx_v_j == __pyx_v_iplus) != 0);
    if (__pyx_t_8) {

      /* "Kramers_Kronig.pyx":26
 *         s5=(ej-e[iplus])
 *         if(j==iplus ):
 *             sum1-=(a*s4+ c )*log( dabsvalue(s4  ))             # <<<<<<<<<<<<<<
 *         elif( j==i ):
 ...
 */
      __pyx_v_sum1 = (__pyx_v_sum1 - (((__pyx_v_a * __pyx_v_s4) + __pyx_v_c) * log(__pyx_f_35Mathematical_Functions_Reflectivity_dabsvalue(__pyx_v_s4))));
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_9 = PyObject_RichCompare(__pyx_t_1, __pyx_v_i, Py_EQ); __Pyx_XGOTREF(__pyx_t_9); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 27, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_8 = __Pyx_PyObject_IsTrue(__pyx_t_9); if (unlikely(__pyx_t_8 < 0)) __PYX_ERR(0, 27, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    if (__pyx_t_8) {

      /* "Kramers_Kronig.pyx":28
 *             sum1-=(a*s4+ c )*log( dabsvalue(s4  ))
 *         elif( j==i ):
 *             sum1+=(a*s4+ c )*log( dabsvalue(s5 ))             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      __pyx_v_sum1 = (__pyx_v_sum1 + (((__pyx_v_a * __pyx_v_s4) + __pyx_v_c) * log(__pyx_f_35Mathematical_Functions_Reflectivity_dabsvalue(__pyx_v_s5))));
 ...
 */
    /*else*/ {
      if (unlikely(__pyx_v_s4 == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        __PYX_ERR(0, 30, __pyx_L1_error)
      }
      __pyx_v_sum1 = (__pyx_v_sum1 + (((__pyx_v_a * __pyx_v_s4) + __pyx_v_c) * log(__pyx_f_35Mathematical_Functions_Reflectivity_dabsvalue((__pyx_v_s5 / __pyx_v_s4)))));
    }
    __pyx_L5:;
 ...
 * 
 */
  __pyx_v_sum1 = (__pyx_v_sum1 * 0.6366197723675814);

  /* "Kramers_Kronig.pyx":33
 * 
 *     sum1*=0.6366197723675814
 *     return sum1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_WriteUnraisable("Kramers_Kronig.KKT_Onepoint", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static void __pyx_f_14Kramers_Kronig_Kramers_Kronig_Transformation_internal(PyArrayObject *__pyx_v_e, PyArrayObject *__pyx_v_im, PyArrayObject *__pyx_v_re, int __pyx_v_L) {
  int __pyx_v_Lred;
  double *__pyx_v_repointer;
  double *__pyx_v_impointer;
  double *__pyx_v_epointer;
  int __pyx_v_j;
  ...
  int __pyx_t_1;
  int __pyx_t_2;
  __Pyx_RefNannySetupContext("Kramers_Kronig_Transformation_internal", 0);
  ...
  __pyx_pybuffernd_re.rcbuffer = &__pyx_pybuffer_re;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_e.rcbuffer->pybuffer, (PyObject*)__pyx_v_e, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 38, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_im.rcbuffer->pybuffer, (PyObject*)__pyx_v_im, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 38, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_re.rcbuffer->pybuffer, (PyObject*)__pyx_v_re, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 38, __pyx_L1_error)
  }
 ...
 */
  __pyx_v_Lred = (__pyx_v_L - 1);

  /* "Kramers_Kronig.pyx":42
 *                                          ndarray[double, ndim=1, mode="c"] re, int L):
 *     cdef int Lred=L-1
 *     cdef double *repointer= <double*> re.data             # <<<<<<<<<<<<<<
 *     cdef double *impointer=<double*> im.data
 ...
 */
  __pyx_v_repointer = ((double *)__pyx_v_re->data);

  /* "Kramers_Kronig.pyx":43
 *     cdef int Lred=L-1
 *     cdef double *repointer= <double*> re.data
 *     cdef double *impointer=<double*> im.data             # <<<<<<<<<<<<<<
 *     cdef double *epointer =<double*> e.data
 * 
 */
  __pyx_v_impointer = ((double *)__pyx_v_im->data);

  /* "Kramers_Kronig.pyx":44
 *     cdef double *repointer= <double*> re.data
 *     cdef double *impointer=<double*> im.data
 *     cdef double *epointer =<double*> e.data             # <<<<<<<<<<<<<<
 * 
 *     for j in range(L):
 */
  __pyx_v_epointer = ((double *)__pyx_v_e->data);

  /* "Kramers_Kronig.pyx":46
 *     cdef double *epointer =<double*> e.data
 * 
 *     for j in range(L):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "Kramers_Kronig.pyx":47
 * 
 *     for j in range(L):
 *         repointer[j]=KKT_Onepoint( j, epointer, impointer, Lred )             # <<<<<<<<<<<<<<
 * 
 */
    (__pyx_v_repointer[__pyx_v_j]) = __pyx_f_14Kramers_Kronig_KKT_Onepoint(__pyx_v_j, __pyx_v_epointer, __pyx_v_impointer, __pyx_v_Lred);
  }
 ...
 */
  ...
  __Pyx_WriteUnraisable("Kramers_Kronig.Kramers_Kronig_Transformation_internal", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_e.rcbuffer->pybuffer);
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_im.rcbuffer->pybuffer);
...
static int __pyx_pymod_exec_Kramers_Kronig(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_Kramers_Kronig},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initKramers_Kronig(void); /*proto*/
PyMODINIT_FUNC initKramers_Kronig(void)
#else
PyMODINIT_FUNC PyInit_Kramers_Kronig(void); /*proto*/
PyMODINIT_FUNC PyInit_Kramers_Kronig(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_Kramers_Kronig(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_Kramers_Kronig(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("Kramers_Kronig", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_Kramers_Kronig) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "Kramers_Kronig")) {
      if (unlikely(PyDict_SetItemString(modules, "Kramers_Kronig", __pyx_m) < 0)) __PYX_ERR(0, 3, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("KKT_Onepoint", (void (*)(void))__pyx_f_14Kramers_Kronig_KKT_Onepoint, "double (int, double *, double *, int)") < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (__Pyx_ExportFunction("Kramers_Kronig_Transformation_internal", (void (*)(void))__pyx_f_14Kramers_Kronig_Kramers_Kronig_Transformation_internal, "void (PyArrayObject *, PyArrayObject *, PyArrayObject *, int)") < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  /*--- Type init code ---*/
  /*--- Type import code ---*/
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "dabsvalue", (void (**)(void))&__pyx_f_35Mathematical_Functions_Reflectivity_dabsvalue, "double (double)") < 0) __PYX_ERR(0, 3, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Kramers_Kronig", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Kramers_Kronig");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
