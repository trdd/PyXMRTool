 ...
 *     roughmat[1][1]=exp(roughfac*cquadr(difvz1vz4) )
 */
 ...
 * 
 */
  ((__pyx_v_roughmat[1])[1]) = exp(__Pyx_c_prod_double(__pyx_t_double_complex_from_parts(__pyx_v_roughfac, 0), __pyx_f_35Mathematical_Functions_Reflectivity_cquadr(__pyx_v_difvz1vz4)));
 ...
 *     roughmat[1][3]=exp(roughfac*cquadr((Mem1[0]).vz2+(Mem2[0]).vz2))             # <<<<<<<<<<<<<<
 * 
 *     roughmat[0][1]=exp(roughfac*cquadr(difvz2vz4) )
 */
 ...
 */
  ((__pyx_v_roughmat[0])[1]) = exp(__Pyx_c_prod_double(__pyx_t_double_complex_from_parts(__pyx_v_roughfac, 0), __pyx_f_35Mathematical_Functions_Reflectivity_cquadr(__pyx_v_difvz2vz4)));
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initMOKE_longitudinal(void); /*proto*/
PyMODINIT_FUNC initMOKE_longitudinal(void)
#else
PyMODINIT_FUNC PyInit_MOKE_longitudinal(void); /*proto*/
PyMODINIT_FUNC PyInit_MOKE_longitudinal(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_MOKE_longitudinal(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_MOKE_longitudinal(void)", 0);
  ...
  if (__Pyx_ImportFunction(__pyx_t_2, "FillC0", (void (**)(void))&__pyx_f_33Multilayer_Functions_Reflectivity_FillC0, "void (__pyx_t_double_complex (*)[2][2], __pyx_t_double_complex (*)[2][2], __pyx_t_double_complex (*)[2][2], __pyx_t_double_complex (*)[2][2])") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_2, "Calculate_Multilayer_equation", (void (**)(void))&__pyx_f_33Multilayer_Functions_Reflectivity_Calculate_Multilayer_equation, "void (__pyx_t_double_complex (*)[2][2], __pyx_t_double_complex (*)[2][2], __pyx_t_double_complex (*)[2][2], __pyx_t_double_complex (*)[2][2], int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init MOKE_longitudinal", 0, __pyx_lineno, __pyx_filename);
    }
