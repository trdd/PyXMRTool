...
#FF_Ya=SampleRepresentation.FFfromScaledAbsorption('C',E1=250,E2=400,E3=500,scaling_factor=pp.newParameter("Ya_scaling"),absorption_filename="C_imag.F",energyshift=pp.newParameter("Ya_eneryshift"),autofitfunction=f2,autofitrange=20)
#FF_Ya=SampleRepresentation.FFfromScaledAbsorption('',E1=250,E2=400,E3=500,scaling_factor=pp.newParameter("Ya_scaling"),absorption_filename="C_imag.F",energyshift=pp.newParameter("Ya_eneryshift"),autofitfunction=f2, autofitrange=20, tabulated_filename="C_tabul.F",tabulated_linereaderfunction=SampleRepresentation.FFfromScaledAbsorption.createTabulatedLinereader(complex_numbers=False))
print "... MFF_Ya"
MFF_Ya=SampleRepresentation.MFFfromXMCD(pp.newParameter("theta_M"), pp.newParameter("phi_M"), "generated_xmcd.txt",  energyshift=pp.newParameter("MFF_energyshift"))
