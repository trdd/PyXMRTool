...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initMultilayer_Functions_Reflectivity(void); /*proto*/
PyMODINIT_FUNC initMultilayer_Functions_Reflectivity(void)
#else
PyMODINIT_FUNC PyInit_Multilayer_Functions_Reflectivity(void); /*proto*/
PyMODINIT_FUNC PyInit_Multilayer_Functions_Reflectivity(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_Multilayer_Functions_Reflectivity(void)", 0);
