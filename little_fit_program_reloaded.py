...
if __name__ == '__main__':
    ...
    pp = Parameters.ParameterPool("Parameters-little_fit_program_reloaded.txt")
    ...
    simu.ReadData(files="little_fit_program_reloaded_data",linereaderfunction=linereader,pointmodifierfunction=None , filenamereaderfunction=namereader)
    ...
    #pp.WriteToFile("Parameters-little_fit_program_reloaded.txt")
